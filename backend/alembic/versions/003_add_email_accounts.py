...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("apify_full_name", sa.String(length=128), nullable=True),
        sa.Column("apify_username", sa.String(length=128), nullable=True),
        sa.Column("apify_user_id", sa.String(length=128), nullable=True),
        sa.Column("apify_token", sa.String(length=1000), nullable=True),
        sa.Column("apify_registered_at", sa.DateTime(), nullable=True),
